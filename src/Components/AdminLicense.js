                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <form>
                              ...
                              <div className="mb-3">
                                <label className="form-label">D/O-S/O</label>
                              ...
                              <div className="mb-3">
                                ...
                                <input type="text" className="form-control" defaultValue="image link"/>
                              </div>
...
<tbody>
      ...
      <br/><br/><button type="submit" className="btn btn-success">DOWNLOAD</button><br/><br/>
    </div>
